                ...
                <div class="col-9 col-sm-8 col-md-7 col-lg-6 col-xl-5 col-xxl-5"> 
                    <div class="signup">
                        ...
                        <form action="../php/signup.php" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="password">Password:</label><input type="password" class="form-control password-input" placeholder="Password" id="password" oninput="passwordStrengthChecker()" name="password"/>
