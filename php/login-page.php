...
<html lang="it">
    ...
    <body>
                ...
                <div class="col-9 col-sm-8 col-md-7 col-lg-6 col-xl-5 col-xxl-5"> 
                    <div class="login">
                        ...
                        <form action="../php/login.php" method="POST">
                            ...
                            <?php endif; ?>
                            <div class="mb-2 mt-5">
                                <label for="username" hidden>Username:</label><input type="text" class="form-control email-username-input" placeholder="Username | Email" name="username" id="username"/>
        ...
        <label for="icon_theme" hidden>Switch for dark/light mode</label><input type="image" src="../icons/theme/lightbulb-regular.svg" class="btn img-theme" id="icon_theme" alt="Theme" onclick="swapTheme()" />
